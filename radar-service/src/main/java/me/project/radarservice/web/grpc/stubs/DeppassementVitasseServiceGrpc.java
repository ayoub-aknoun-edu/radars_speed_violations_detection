package me.project.radarservice.web.grpc.stubs;
...
public final class DeppassementVitasseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest,
      me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse> getDepasseVitsseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "depasseVitsse",
      requestType = me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest.class,
      responseType = me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest,
      me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse> getDepasseVitsseMethod() {
    io.grpc.MethodDescriptor<me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest, me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse> getDepasseVitsseMethod;
      ...
      synchronized (DeppassementVitasseServiceGrpc.class) {
        if ((getDepasseVitsseMethod = DeppassementVitasseServiceGrpc.getDepasseVitsseMethod) == null) {
          DeppassementVitasseServiceGrpc.getDepasseVitsseMethod = getDepasseVitsseMethod = 
              io.grpc.MethodDescriptor.<me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest, me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "DeppassementVitasseService", "depasseVitsse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse> getGetRadarsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getRadars",
      requestType = com.google.protobuf.Empty.class,
      responseType = me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse> getGetRadarsMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse> getGetRadarsMethod;
      ...
      synchronized (DeppassementVitasseServiceGrpc.class) {
        if ((getGetRadarsMethod = DeppassementVitasseServiceGrpc.getGetRadarsMethod) == null) {
          DeppassementVitasseServiceGrpc.getGetRadarsMethod = getGetRadarsMethod = 
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse.getDefaultInstance()))
  ...
  public static abstract class DeppassementVitasseServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void depasseVitsse(me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest request,
        io.grpc.stub.StreamObserver<me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse> responseObserver) {
    ...
    public void getRadars(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest,
                me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse>(
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                ...
                me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse>(
  ...
  public static final class DeppassementVitasseServiceBlockingStub extends io.grpc.stub.AbstractStub<DeppassementVitasseServiceBlockingStub> {
    ...
    /**
     */
    public me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse depasseVitsse(me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest request) {
    ...
    /**
     */
    public java.util.Iterator<me.project.radarservice.web.grpc.stubs.DepassementVitasse.RadarResponse> getRadars(
  ...
  public static final class DeppassementVitasseServiceFutureStub extends io.grpc.stub.AbstractStub<DeppassementVitasseServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse> depasseVitsse(
        me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DEPASSE_VITSSE:
          serviceImpl.depasseVitsse((me.project.radarservice.web.grpc.stubs.DepassementVitasse.DeppassementRequest) request,
              (io.grpc.stub.StreamObserver<me.project.radarservice.web.grpc.stubs.DepassementVitasse.deppassementResponse>) responseObserver);
          break;
  ...
  private static abstract class DeppassementVitasseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.project.radarservice.web.grpc.stubs.DepassementVitasse.getDescriptor();
    }
